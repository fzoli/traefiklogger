...
func TestShortPost(t *testing.T) {
	expectedLogs := map[traefiklogger.LogFormat]string{
		...
		traefiklogger.JSONFormat: "{\"system\":\"HTTP\",\"time\":\"2020-12-15T13:30:40.999Z\",\"remoteAddr\":\"127.0.0.1\",\"method\":\"POST\",\"url\":\"http://localhost/short-post\",\"status\":200,\"statusText\":\"OK\",\"proto\":\"HTTP/1.1\",\"requestHeaders\":{\"Accept\":\"text/plain\"},\"responseHeaders\":{\"Content-Type\":\"text/plain\"},\"responseContentLength\":2}\n",
	}
